...
static int s_suppress_connect_prints = 0;

void apps_set_suppress_connect_prints(int on)
{
    s_suppress_connect_prints = on ? 1 : 0;
}

int apps_connect_prints_suppressed(void)
{
    return s_suppress_connect_prints;
}
