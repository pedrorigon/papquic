...
typedef struct ossl_quic_packet_log_event_st OSSL_QUIC_PACKET_LOG_EVENT;
...
typedef struct quic_handshake_timing_st {
    int initialized;
    int enabled;
    int server_client_logged;
    int server_validated_logged;
    int server_hs_done_logged;
    int client_ch_logged;
    int client_sh_logged;
    int client_hs_done_logged;
    int client_cert_logged;
    int client_cv_logged;
    int server_cert_logged;
    int server_cv_logged;
    int server_shprep_logged;
    int server_hsbuild_logged;

    int have_server_clienthello_time;
    OSSL_TIME server_clienthello_time;
    int server_clienthello_process_active;
    int have_server_clienthello_process;
    OSSL_TIME server_clienthello_process_start;
    OSSL_TIME server_clienthello_process;

    int have_server_hello_preparation;
    OSSL_TIME server_hello_preparation;

    int server_kex_active;
    int have_server_kex_latency;
    OSSL_TIME server_kex_start;
    OSSL_TIME server_kex_latency;

    int server_cert_build_active;
    int have_server_cert_build;
    OSSL_TIME server_cert_build_start;
    OSSL_TIME server_cert_build;

    int server_cert_verify_active;
    int have_server_cert_verify;
    OSSL_TIME server_cert_verify_start;
    OSSL_TIME server_cert_verify;

    int server_handshake_build_active;
    int have_server_handshake_build;
    OSSL_TIME server_handshake_build_start;
    OSSL_TIME server_handshake_build;

    int client_keyshare_active;
    int have_client_keyshare;
    OSSL_TIME client_keyshare_start;
    OSSL_TIME client_keyshare;

    int client_hello_build_active;
    int have_client_hello_build;
    OSSL_TIME client_hello_build_start;
    OSSL_TIME client_hello_build;

    int have_client_hello_sent;
    OSSL_TIME client_hello_sent;
    int have_client_hello_rtt;
    OSSL_TIME client_hello_rtt;

    int client_kex_active;
    int have_client_kex;
    OSSL_TIME client_kex_start;
    OSSL_TIME client_kex;

    int client_cert_chain_active;
    int have_client_cert_chain;
    OSSL_TIME client_cert_chain_start;
    OSSL_TIME client_cert_chain;

    int client_cert_verify_active;
    int have_client_cert_verify;
    OSSL_TIME client_cert_verify_start;
    OSSL_TIME client_cert_verify;

    int client_cv_check_active;
    int have_client_cv_check;
    OSSL_TIME client_cv_check_start;
    OSSL_TIME client_cv_check;

    int have_client_validation_delay;
    OSSL_TIME client_validation_delay;

    BUF_MEM *pending_server_initial_line;
    BUF_MEM *pending_client_finished_line;
    BUF_MEM *pending_server_handshake_done_line;

    FILE *log_stream;

    int client_ready;
} QUIC_HANDSHAKE_TIMING;

typedef enum {
    OSSL_QUIC_TIMING_PHASE_BEFORE = 0,
    OSSL_QUIC_TIMING_PHASE_AFTER  = 1,
} OSSL_QUIC_TIMING_PHASE;

void ossl_quic_timing_client_keyshare_begin(SSL_CONNECTION *s);
void ossl_quic_timing_client_keyshare_complete(SSL_CONNECTION *s);
void ossl_quic_timing_client_keyshare_abort(SSL_CONNECTION *s);
void ossl_quic_timing_client_hello_build_begin(SSL_CONNECTION *s);
void ossl_quic_timing_client_hello_build_complete(SSL_CONNECTION *s);
void ossl_quic_timing_client_hello_build_abort(SSL_CONNECTION *s);
void ossl_quic_timing_client_hello_sent(SSL_CONNECTION *s);
void ossl_quic_timing_client_processed_server_hello(SSL_CONNECTION *s);
void ossl_quic_timing_client_kex_begin(SSL_CONNECTION *s);
void ossl_quic_timing_client_kex_complete(SSL_CONNECTION *s);
void ossl_quic_timing_client_kex_abort(SSL_CONNECTION *s);
void ossl_quic_timing_client_cert_chain_begin(SSL_CONNECTION *s);
void ossl_quic_timing_client_cert_chain_complete(SSL_CONNECTION *s);
void ossl_quic_timing_client_cert_chain_abort(SSL_CONNECTION *s);
void ossl_quic_timing_client_cert_verify_begin(SSL_CONNECTION *s);
void ossl_quic_timing_client_cert_verify_complete(SSL_CONNECTION *s);
void ossl_quic_timing_client_cert_verify_abort(SSL_CONNECTION *s);
void ossl_quic_timing_client_cert_verify_check_begin(SSL_CONNECTION *s);
void ossl_quic_timing_client_cert_verify_check_complete(SSL_CONNECTION *s);
void ossl_quic_timing_client_cert_verify_check_abort(SSL_CONNECTION *s);

void ossl_quic_timing_server_client_hello_process_begin(SSL_CONNECTION *s);
void ossl_quic_timing_server_client_hello_processed(SSL_CONNECTION *s);
void ossl_quic_timing_server_hello_ready(SSL_CONNECTION *s);
void ossl_quic_timing_server_kex_begin(SSL_CONNECTION *s);
void ossl_quic_timing_server_kex_complete(SSL_CONNECTION *s);
void ossl_quic_timing_server_kex_abort(SSL_CONNECTION *s);
void ossl_quic_timing_server_cert_build_begin(SSL_CONNECTION *s);
void ossl_quic_timing_server_cert_build_complete(SSL_CONNECTION *s);
void ossl_quic_timing_server_cert_build_abort(SSL_CONNECTION *s);
void ossl_quic_timing_server_cert_verify_begin(SSL_CONNECTION *s);
void ossl_quic_timing_server_cert_verify_complete(SSL_CONNECTION *s);
void ossl_quic_timing_server_cert_verify_abort(SSL_CONNECTION *s);
void ossl_quic_timing_server_handshake_build_begin(SSL_CONNECTION *s);
void ossl_quic_timing_server_handshake_build_complete(SSL_CONNECTION *s);
void ossl_quic_timing_server_handshake_build_abort(SSL_CONNECTION *s);

QUIC_HANDSHAKE_TIMING *ossl_quic_timing_get(SSL_CONNECTION *s);
int ossl_quic_timing_buffer_server_hello_line(SSL_CONNECTION *s,
                                              const char *data, size_t len);
void ossl_quic_timing_flush_server_hello_line(SSL_CONNECTION *s, FILE *stream);
int ossl_quic_timing_buffer_client_finished_line(SSL_CONNECTION *s,
                                                 const char *data, size_t len);
void ossl_quic_timing_flush_client_finished_line(SSL_CONNECTION *s,
                                                 FILE *stream);
int ossl_quic_timing_buffer_server_hs_done_line(SSL_CONNECTION *s,
                                               const char *data, size_t len);
void ossl_quic_timing_flush_server_hs_done_line(SSL_CONNECTION *s,
                                                FILE *stream);
...
#else
typedef int QUIC_HANDSHAKE_TIMING;
typedef int OSSL_QUIC_TIMING_PHASE;
# define OSSL_QUIC_TIMING_PHASE_BEFORE 0
# define OSSL_QUIC_TIMING_PHASE_AFTER  1
# define ossl_quic_timing_client_keyshare_begin(s) ((void)0)
# define ossl_quic_timing_client_keyshare_complete(s) ((void)0)
# define ossl_quic_timing_client_keyshare_abort(s) ((void)0)
# define ossl_quic_timing_client_hello_build_begin(s) ((void)0)
# define ossl_quic_timing_client_hello_build_complete(s) ((void)0)
# define ossl_quic_timing_client_hello_build_abort(s) ((void)0)
# define ossl_quic_timing_client_hello_sent(s) ((void)0)
# define ossl_quic_timing_client_processed_server_hello(s) ((void)0)
# define ossl_quic_timing_client_kex_begin(s) ((void)0)
# define ossl_quic_timing_client_kex_complete(s) ((void)0)
# define ossl_quic_timing_client_kex_abort(s) ((void)0)
# define ossl_quic_timing_client_cert_chain_begin(s) ((void)0)
# define ossl_quic_timing_client_cert_chain_complete(s) ((void)0)
# define ossl_quic_timing_client_cert_chain_abort(s) ((void)0)
# define ossl_quic_timing_client_cert_verify_begin(s) ((void)0)
# define ossl_quic_timing_client_cert_verify_complete(s) ((void)0)
# define ossl_quic_timing_client_cert_verify_abort(s) ((void)0)
# define ossl_quic_timing_client_cert_verify_check_begin(s) ((void)0)
# define ossl_quic_timing_client_cert_verify_check_complete(s) ((void)0)
# define ossl_quic_timing_client_cert_verify_check_abort(s) ((void)0)
# define ossl_quic_timing_server_client_hello_process_begin(s) ((void)0)
# define ossl_quic_timing_server_client_hello_processed(s) ((void)0)
# define ossl_quic_timing_server_hello_ready(s) ((void)0)
# define ossl_quic_timing_server_kex_begin(s) ((void)0)
# define ossl_quic_timing_server_kex_complete(s) ((void)0)
# define ossl_quic_timing_server_kex_abort(s) ((void)0)
# define ossl_quic_timing_server_cert_build_begin(s) ((void)0)
# define ossl_quic_timing_server_cert_build_complete(s) ((void)0)
# define ossl_quic_timing_server_cert_build_abort(s) ((void)0)
# define ossl_quic_timing_server_cert_verify_begin(s) ((void)0)
# define ossl_quic_timing_server_cert_verify_complete(s) ((void)0)
# define ossl_quic_timing_server_cert_verify_abort(s) ((void)0)
# define ossl_quic_timing_server_handshake_build_begin(s) ((void)0)
# define ossl_quic_timing_server_handshake_build_complete(s) ((void)0)
# define ossl_quic_timing_server_handshake_build_abort(s) ((void)0)
# define ossl_quic_timing_get(s) NULL
# define ossl_quic_timing_buffer_server_hello_line(s, d, l) 0
# define ossl_quic_timing_flush_server_hello_line(s, f) ((void)0)
# define ossl_quic_timing_buffer_client_finished_line(s, d, l) 0
# define ossl_quic_timing_flush_client_finished_line(s, f) ((void)0)
# define ossl_quic_timing_buffer_server_hs_done_line(s, d, l) 0
# define ossl_quic_timing_flush_server_hs_done_line(s, f) ((void)0)
# define ossl_quic_timing_maybe_emit_internal(e, n, t, m, p) ((void)0)
#endif
...
struct ssl_connection_st {
    ...
    QUIC_TLS *qtls;
# ifndef OPENSSL_NO_QUIC
    QUIC_HANDSHAKE_TIMING quic_timing;
# endif
