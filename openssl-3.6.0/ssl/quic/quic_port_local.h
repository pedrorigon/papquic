...
struct quic_port_st {
    ...
    /* Best-effort estimate of the local path MTU/MDPL. */
    size_t                          tx_max_udp_payload_size;
    ...
    /* Should this port bypass anti-amplification limits? */
    unsigned int                    unlimited_amplification         : 1;
