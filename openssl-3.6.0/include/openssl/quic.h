...
/*
 * Enable or disable verbose QUIC debug logging inside libssl.
 */
void OSSL_QUIC_set_debug_mode(int enabled);

/*
 * Set the role label (for example, "CLIENT" or "SERVER") used by QUIC debug logs.
 */
void OSSL_QUIC_set_debug_role(const char *role);

/*
 * Enable or disable packet transmission logging inside libssl.
 */
